...
select CH_INVOICELINE.AD_ORG_ID,CH_ORG.NAME,CH_INVOICELINE.M_PRODUCT_ID,SUM(QTY),SUM(LINEAMT),CH_INVOICELINE.CREATED from CH_INVOICELINE inner join CH_ORG on CH_INVOICELINE.AD_ORG_ID=CH_ORG.AD_ORG_ID group by CH_INVOICELINE.AD_ORG_ID,CH_INVOICELINE.M_PRODUCT_ID,CH_ORG.NAME,CH_INVOICELINE.CREATED having CH_INVOICELINE.M_PRODUCT_ID=1111706.0

select count(1) from (select CH_INVOICELINE.AD_ORG_ID,CH_ORG.NAME,CH_INVOICELINE.M_PRODUCT_ID,SUM(QTY),SUM(LINEAMT),CH_INVOICELINE.CREATED from CH_INVOICELINE inner join CH_ORG on CH_INVOICELINE.AD_ORG_ID=CH_ORG.AD_ORG_ID group by CH_INVOICELINE.AD_ORG_ID,CH_INVOICELINE.M_PRODUCT_ID,CH_ORG.NAME,CH_INVOICELINE.CREATED having CH_INVOICELINE.M_PRODUCT_ID=1111706.0)

select CH_INVOICELINE.AD_ORG_ID,CH_ORG.NAME,CH_INVOICELINE.M_PRODUCT_ID,SUM(QTY),SUM(LINEAMT),CH_INVOICELINE.CREATED from CH_INVOICELINE inner join CH_ORG on CH_INVOICELINE.AD_ORG_ID=CH_ORG.AD_ORG_ID group by CH_INVOICELINE.AD_ORG_ID,CH_INVOICELINE.M_PRODUCT_ID,CH_ORG.NAME,CH_INVOICELINE.CREATED having CH_INVOICELINE.M_PRODUCT_ID=1111706.0 order by CH_INVOICELINE.CREATED asc
