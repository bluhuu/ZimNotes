...
下面的快捷键是重构里面常用的,本人就自己喜欢且常用的整理一下(注:一般重构的快捷键都是Alt+Shift 开头的了)
...
切换
Ctrl+f6                            切换窗口<可改为ctrl+tab方便>
Ctrl+f7                            可以在视图之间切换 ,如编辑视图,输出视图,工程视图
Ctrl+f8                            可以在不同的观察视图中切换,就是在java视图,调试视图,等之间
Ctrl+m                             切换到最大化当前窗口
Ctrl+e                             Ctrl+f6的功能相同,以输入的方式切换窗口
Ctrl+T                             可以直接显示光标所在内容的类图,并跳到输入内容部分
Ctrl+鼠标                          在源代码中快速跳转

Ctrl + F11                         调试上次程序
Ctrl+Shift+F                       程序代码自动排版
Ctrl+Shift+O                       自动加入引用。说明：Import类
